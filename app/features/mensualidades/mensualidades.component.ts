      ...
      <div class="main-container">
        ...
        <main class="content">
          ...
          <div class="placeholder-card">
            ...
            <ul>
              <li>✅ Generación masiva de mensualidades por mes</li>
              <li>✅ Resumen mensual de cobros</li>
              <li>✅ Estadísticas de pagadas, pendientes y vencidas</li>
              <li>✅ Porcentaje de cumplimiento</li>
              <li>✅ Total esperado vs total recaudado</li>
            </ul>
          </div>
        </main>
      </div>
